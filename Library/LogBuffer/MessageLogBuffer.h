...
typedef struct 
{
	pthread_mutex_t 		read_mutex; 	// two thread can read this (e.g. log printing non-rt thread and prosthetic_control_rt_task can read it before terminating the program during an exit(1);)
