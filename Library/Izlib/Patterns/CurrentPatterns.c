...
CurrentPatterns* allocate_current_patterns(Network *network, ExpStats *trial_stats, CurrentPatterns* current_patterns)
{
	if (network == NULL)
	{
...
CurrentPatterns* deallocate_current_patterns(Network *network, ExpStats *trial_stats, CurrentPatterns* current_patterns)
{
