...
SpikePatterns* allocate_spike_patterns(ExpStats *trial_stats, SpikePatterns* spike_patterns);
SpikePatterns* deallocate_spike_patterns(ExpStats *trial_stats, SpikePatterns* spike_patterns);
...
bool add_single_spike_pattern_to_spike_patterns(ExpStats *trial_stats, SpikePatterns* spike_patterns, SingleSpikePattern* single_spike_pattern);
