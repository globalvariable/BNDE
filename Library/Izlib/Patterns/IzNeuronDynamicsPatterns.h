...
{
	ExpStats						*trial_stats;	// get num of patterns from num of trials
...
NetworkIzNeuronDynamicsPatterns* allocate_network_izneuron_dynamics_patterns(Network *network, ExpStats *trial_stats, NetworkIzNeuronDynamicsPatterns* network_neuron_dynamics_patterns);
NetworkIzNeuronDynamicsPatterns* deallocate_network_izneuron_dynamics_patterns(Network *network, ExpStats *trial_stats, NetworkIzNeuronDynamicsPatterns* network_neuron_dynamics_patterns);
