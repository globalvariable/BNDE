...
NeuronDynamicsGraphScroll* allocate_neuron_dynamics_graph_scroll(GtkWidget *hbox, NeuronDynamicsGraphScroll *graph, unsigned int num_of_data_points, TimeStamp sampling_interval, unsigned int num_of_data_points_to_scroll, TimeStamp buffer_followup_latency, unsigned int num_of_markers, ExpStatusEvents *trial_status_events)
{
	unsigned int i;
	if (graph != NULL)
	{
...
NeuronDynamicsGraphScrollLimited* allocate_neuron_dynamics_graph_scroll_limited(GtkWidget *hbox, NeuronDynamicsGraphScrollLimited *graph, unsigned int num_of_data_points, TimeStamp sampling_interval, unsigned int num_of_data_points_to_scroll, TimeStamp buffer_followup_latency, unsigned int num_of_markers, ExpStatusEvents *trial_status_events, NeuronDynamicsBufferLimited* limited_dynamics_buffer, unsigned int limited_dynamics_buffer_list_idx)
{
	unsigned int i;
	if (graph != NULL)
	{
