...
NetworkSpikePatternGraphScroll* allocate_network_spike_pattern_graph_scroll(Network* network, GtkWidget *hbox, NetworkSpikePatternGraphScroll *graph, unsigned int num_of_data_points, TimeStamp sampling_interval, int graph_height, unsigned int num_of_data_points_to_scroll, TimeStamp spike_buffer_followup_latency, SpikeData **source_spike_data_to_plot, unsigned int num_of_markers, ExpStatusEvents *trial_status_events, unsigned int	num_of_spike_data_buffer)
{
	GdkColor color_bg;
	GdkColor color_line;
	GdkColor color_grid;
...
bool handle_spike_pattern_graph_scrolling_and_plotting(NetworkSpikePatternGraphScroll *graph, Network *network, TimeStamp current_system_time)
{
	...
	ExpStatusEventItem		*status_event_item;
