...
CurrentPatternGraphScroll* allocate_current_pattern_graph_scroll(GtkWidget *hbox, CurrentPatternGraphScroll *graph, unsigned int num_of_data_points, TimeStamp sampling_interval, unsigned int num_of_data_points_to_scroll, TimeStamp buffer_followup_latency, unsigned int num_of_markers, ExpStatusEvents *trial_status_events)
{
	unsigned int i;
	if (graph != NULL)
	{
...
CurrentPatternGraphScrollLimited* allocate_current_pattern_graph_scroll_limited(GtkWidget *hbox, CurrentPatternGraphScrollLimited *graph, unsigned int num_of_data_points, TimeStamp sampling_interval, unsigned int num_of_data_points_to_scroll, TimeStamp buffer_followup_latency, unsigned int num_of_markers, ExpStatusEvents *trial_status_events, CurrentPatternBufferLimited* limited_current_buffer, unsigned int limited_current_buffer_list_idx)
{
	unsigned int i;
	if (graph != NULL)
	{
