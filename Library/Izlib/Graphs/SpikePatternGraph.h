...
NetworkSpikePatternGraphScroll* allocate_network_spike_pattern_graph_scroll(Network* network, GtkWidget *hbox, NetworkSpikePatternGraphScroll *graph, unsigned int num_of_data_points, TimeStamp sampling_interval, int graph_height, unsigned int num_of_data_points_to_scroll, TimeStamp spike_buffer_followup_latency, SpikeData **source_spike_data_to_plot, unsigned int num_of_markers, ExpStatusEvents *trial_status_events, unsigned int	num_of_spike_data_buffer);  // this height should be adjusted manually so that the graph size will be determined.
...
NetworkSpikePatternGraphScroll* allocate_network_spike_pattern_graph_scroll_exclude_poisson(Network* network, GtkWidget *hbox, NetworkSpikePatternGraphScroll *graph, unsigned int num_of_data_points, TimeStamp sampling_interval, int graph_height, unsigned int num_of_data_points_to_scroll, TimeStamp spike_buffer_followup_latency, SpikeData **source_spike_data_to_plot, unsigned int num_of_markers, ExpStatusEvents *trial_status_events, unsigned int	num_of_spike_data_buffer);
