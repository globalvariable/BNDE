...
#include "../../../ExperimentHandlers/Applications/BMIExpController/ExpParadigm/ExpCtrlParadigm.h"
...
ThreePhasePoissonFiring* allocate_three_phase_poisson_firing_data(Network *network, ExpCtrlParadigmRobotReach *paradigm, ThreePhasePoissonFiring* firing_data);
ThreePhasePoissonFiring* deallocate_three_phase_poisson_firing_data(Network *network, ExpCtrlParadigmRobotReach *paradigm, ThreePhasePoissonFiring* firing_data);
