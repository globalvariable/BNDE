...
bool submit_cartesian_robotic_space_borders(ThreeDofRobot *robot_arm,  ProstheticCtrlParadigmRobotReach *paradigm, double depth_min, double depth_max, double lateral_min, double lateral_max, double height_min, double height_max)
{
	if (robot_arm->cartesian_security_limits.depth_min >= depth_min)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_cartesian_robotic_space_borders", "robot_arm->cartesian_security_limits.depth_min > depth_min.");
	if (robot_arm->cartesian_security_limits.depth_max <= depth_max)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_cartesian_robotic_space_borders", "robot_arm->cartesian_security_limits.depth_max <= depth_max.");
	if (robot_arm->cartesian_security_limits.lateral_min >= lateral_min)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_cartesian_robotic_space_borders", "robot_arm->cartesian_security_limits.lateral_min >= lateral_min.");
	if (robot_arm->cartesian_security_limits.lateral_max <= lateral_max)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_cartesian_robotic_space_borders", "robot_arm->cartesian_security_limits.lateral_max <= lateral_max.");
	if (robot_arm->cartesian_security_limits.height_min >= height_min)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_cartesian_robotic_space_borders", "robot_arm->cartesian_security_limits.height_min = height_min.");
	if (robot_arm->cartesian_security_limits.height_max <= height_max)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_cartesian_robotic_space_borders", "robot_arm->cartesian_security_limits.height_max <= height_max.");
...
bool submit_polar_robotic_space_borders(ThreeDofRobot *robot_arm, ProstheticCtrlParadigmRobotReach *paradigm, double joint_angle_base_lower_limit, double joint_angle_base_upper_limit, double joint_angle_shoulder_lower_limit, double joint_angle_shoulder_upper_limit, double joint_angle_elbow_lower_limit, double joint_angle_elbow_upper_limit)
{
	if (robot_arm->servos[BASE_SERVO].angular_security_limit.min >= joint_angle_base_lower_limit)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_polar_robotic_space_borders", "robot_arm->servos[BASE_SERVO].angular_security_limit.min >= joint_angle_base_lower_limit.");
	if (robot_arm->servos[BASE_SERVO].angular_security_limit.max <= joint_angle_base_upper_limit)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_polar_robotic_space_borders", "robot_arm->servos[BASE_SERVO].angular_security_limit.max <= joint_angle_base_upper_limit.");

	if (robot_arm->servos[SHOULDER_SERVO].angular_security_limit.min >= joint_angle_shoulder_lower_limit)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_polar_robotic_space_borders", "robot_arm->servos[SHOULDER_SERVO].angular_security_limit.min >= joint_angle_shoulder_lower_limit.");
	if (robot_arm->servos[SHOULDER_SERVO].angular_security_limit.max <= joint_angle_shoulder_upper_limit)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_polar_robotic_space_borders", "robot_arm->servos[SHOULDER_SERVO].angular_security_limit.max <= joint_angle_shoulder_upper_limit.");

	if (robot_arm->servos[ELBOW_SERVO].angular_security_limit.min >= joint_angle_elbow_lower_limit)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_polar_robotic_space_borders", "robot_arm->servos[ELBOW_SERVO].angular_security_limit.min >= joint_angle_elbow_lower_limit.");
	if (robot_arm->servos[ELBOW_SERVO].angular_security_limit.max <= joint_angle_elbow_upper_limit)
		return print_message(ERROR_MSG ,"ExperimentHandlers", "ProstheticCtrlParadigm", "submit_polar_robotic_space_borders", "robot_arm->servos[ELBOW_SERVO].angular_security_limit.max <= joint_angle_elbow_upper_limit.");
