			...
			case GUI_2_EXP_CTRL_MSG_ENABLE_EXP_CTRLLING:	
				switch (*trial_status)
				{
					...
					case TRIAL_STATUS_WAIT_FOR_LEVER_PRESS:	
						print_message(ERROR_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", "Exp Enable is not possible when TRIAL_STATUS_WAIT_FOR_LEVER_PRESS. It must be Enabled already.");
						break;
					default:
...
//							print_message(WARNING_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", "Reached paradigm->num_of_robot_start_positions number. Cannot be increase  more.");
						...
						break;
					case TRIAL_STATUS_WAIT_FOR_LEVER_PRESS:
						print_message(ERROR_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", "Increasing threshold cannot be done during TRIAL_STATUS_WAIT_FOR_LEVER_PRESS");
						break;
					default:
						print_message(BUG_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", str_gui_msg);
						get_trial_status_type_string(*trial_status, str_status);   
...
//							print_message(WARNING_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", "Reached paradigm->current_trial_data.robot_start_position_idx == 1. Cannot  decrease  more.");
						...
						break;
					case TRIAL_STATUS_WAIT_FOR_LEVER_PRESS:
						print_message(ERROR_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", "Decreasing threshold cannot be done during TRIAL_STATUS_WAIT_FOR_LEVER_PRESS");
						break;
					default:
						print_message(BUG_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", str_gui_msg);
						get_trial_status_type_string(*trial_status, str_status);   
			...
			case GUI_2_EXP_CTRL_MSG_BROADCAST_START_RECORDING:
				switch (*trial_status)
				{
					...
					case TRIAL_STATUS_START_TRIAL_AVAILABLE:	
						...
						break;
					case TRIAL_STATUS_WAIT_FOR_LEVER_PRESS:	
						print_message(ERROR_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", "Cannot start recording when TRIAL_STATUS_WAIT_FOR_LEVER_PRESS");
						break;
					default:
						print_message(BUG_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", str_gui_msg);
						get_trial_status_type_string(*trial_status, str_status);   
			...
			case GUI_2_EXP_CTRL_MSG_BROADCAST_STOP_RECORDING:		
				switch (*trial_status)
				{
					...
					case TRIAL_STATUS_START_TRIAL_AVAILABLE:	
						...
						break;	
					case TRIAL_STATUS_WAIT_FOR_LEVER_PRESS:	
						print_message(ERROR_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", "Cannot stop recording when TRIAL_STATUS_WAIT_FOR_LEVER_PRESS");
						break;		
					default:
						print_message(BUG_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", str_gui_msg);
						get_trial_status_type_string(*trial_status, str_status);   
			...
			case GUI_2_EXP_CTRL_MSG_BROADCAST_CANCEL_RECORDING:
				switch (*trial_status)
				{
					...
					case TRIAL_STATUS_START_TRIAL_AVAILABLE:	
						...
						break;		
					case TRIAL_STATUS_WAIT_FOR_LEVER_PRESS:	
						print_message(ERROR_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", "Cannot cancel recording when TRIAL_STATUS_WAIT_FOR_LEVER_PRESS");
						break;	
					default:
						print_message(BUG_MSG ,"ExpControl", "HandleGui2ExpCtrlMsgs", "handle_gui_to_exp_control_msg", str_gui_msg);
						get_trial_status_type_string(*trial_status, str_status);   
