				...
				switch (*prosthetic_ctrl_status)
				{
					case PROSTHETIC_CTRL_STATUS_OUT_OF_TRIAL:
						*prosthetic_ctrl_status = PROSTHETIC_CTRL_STATUS_AVAILABLE_TO_CONTROL;
						...
						if (prosthetic_ctrl_paradigm->target_info.selected_position_idx == 0) // left target selected
						{
							prosthetic_ctrl_paradigm->left_bias_constant = prosthetic_ctrl_paradigm->left_target_left_bias_constant_gui;
							prosthetic_ctrl_paradigm->right_bias_constant = prosthetic_ctrl_paradigm->left_target_right_bias_constant_gui;
						}
						if (prosthetic_ctrl_paradigm->target_info.selected_position_idx == 1) // right target selected
						{
							prosthetic_ctrl_paradigm->left_bias_constant = prosthetic_ctrl_paradigm->right_target_left_bias_constant_gui;
							prosthetic_ctrl_paradigm->right_bias_constant = prosthetic_ctrl_paradigm->right_target_right_bias_constant_gui;
						}
