...
#define DATA_FORMAT_VERSION	MAX_NUMBER_OF_DATA_FORMAT_VER-1	// Change this according to the intended data format/   Upper limit is MAX_NUMBER_OF_DATA_FORMAT_VER-1
