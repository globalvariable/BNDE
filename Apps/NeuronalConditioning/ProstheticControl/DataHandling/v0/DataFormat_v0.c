...
int create_data_directory_v0(int num, ...)
{
	...
	if ((ret = mkdir(data_directory_path, S_IRWXU | S_IRWXG | S_IROTH | S_IXOTH | S_IWOTH)) != 0)
	{
		...
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "create_data_directory_v0", "mkdir() != 0");
	}	

	if (! create_data_files(rec_start, data_directory_path))
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "create_data_directory_v0", "! create_data_files.");
...
int fclose_all_data_files_v0(int num, ...)
{
	...
	if (! close_meta_data(rec_end))
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "create_data_directory_v0", "! close_meta_data");

	if (! close_prosthetic_ctrl_status_data())
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "create_data_directory_v0", "! close_prosthetic_ctrl_status_data");

	if (! close_joint_angle_data())
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "create_data_directory_v0", "! close_joint_angle_data");

	if (! close_robot_pulse_data())
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "create_data_directory_v0", "! close_robot_pulse_data");
...
int delete_data_directory_v0(int num, ...)
{
	...
	if (! delete_data_files(data_directory_path))
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "delete_data_directory_v0", "! delete_data_files(data_directory_path)");

	if (rmdir(data_directory_path) != 0) 
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "delete_data_directory_v0", "! remove(data_directory_path)");
...
int write_to_data_files_v0(int num, ...)
{
	...
	if (! write_to_prosthetic_ctrl_status_data(prosthetic_ctrl_status_history))
		return print_message(ERROR_MSG ,"DioControl", "DataFormat_v0", "write_to_data_files_v0", "! write_to_prosthetic_ctrl_status_data()");

	if (! write_to_joint_angle_data(robot_angle_history ))
		return print_message(ERROR_MSG ,"DioControl", "DataFormat_v0", "write_to_data_files_v0", "! write_to_joint_angle_data()");

	if (! write_to_robot_pulse_data(robot_pulse_history))
		return print_message(ERROR_MSG ,"DioControl", "DataFormat_v0", "write_to_data_files_v0", "! write_to_robot_pulse_data()");
...
static int create_data_files(TimeStamp rec_start, char *data_directory_path)
{
	if (!create_meta_data(rec_start, data_directory_path))
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "create_data_files", "! create_meta_data");
	
	if (!create_prosthetic_ctrl_status_data(data_directory_path))
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "create_data_files", "! create_prosthetic_ctrl_status_data");

	if (!create_joint_angle_data(data_directory_path))
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "create_data_files", "! create_joint_angle_data");

	if (!create_robot_pulse_data(data_directory_path))
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "create_data_files", "! create_robot_pulse_data");
...
static int delete_data_files(char *data_directory_path)
{
	if (! delete_meta_data(data_directory_path))
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "delete_data_files_v0", "! delete_meta_data(data_directory_path)");
	
	if (! delete_prosthetic_ctrl_status_data(data_directory_path))
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "delete_data_files_v0", "! delete_prosthetic_ctrl_status_data(data_directory_path)");

	if (! delete_joint_angle_data(data_directory_path))
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "delete_data_files_v0", "! delete_joint_angle_data(data_directory_path)");

	if (! delete_robot_pulse_data(data_directory_path))
		return print_message(ERROR_MSG ,"ProstheticControl", "DataFormat_v0", "delete_data_files_v0", "! delete_robot_pulse_data(data_directory_path)");
